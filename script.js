...
const CONFIG = {
  ...
  rareEvents: {
    ...
    messages: [
      ...
      { icon: "🚀", title: "Стрим взлетел", text: "Донат-эффект принёс +1000 $MELL", bonus: 1500 },
      { icon: "🐸", title: "Мемный дух услышал тебя", text: "+150 $MELL просто так", bonus: 300 }
    ]
  },
  ...
  firebase: {
    apiKey: "AIzaSyCPG0hE7AXpNSjoY1HfBS4mpbvRMgS4yRY",
    authDomain: "mellstroy-efb30.firebaseapp.com",
    projectId: "mellstroy-efb30",
    storageBucket: "mellstroy-efb30.firebasestorage.app",
    messagingSenderId: "295800228387",
    appId: "1:295800228387:web:a9432f1d88fe0a8866ff96"
  },
  leaderboard: {
...
function firebaseIsConfigured(){
  return CONFIG.firebase.apiKey && !CONFIG.firebase.apiKey.includes("ВСТАВЬТЕ");
}
